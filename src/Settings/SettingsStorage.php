...
use Soopno\Services\Location\CurrentLocation;
use Soopno\Services\DateTime\DateTimeService;
use Soopno\Services\Settings\SettingsStorageInterface;
    ...
    public function getFrontendSettings()
    {
        ...
        return [
            ...
            'general'                => [
                ...
                'useWindowVueInAmelia'                   => $this->getSetting('general', 'useWindowVueInAmelia'),
                // 'googleRecaptcha'                              => [
