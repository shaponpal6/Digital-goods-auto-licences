...
namespace Soopno\Translations;

/**
 * Class BackendStrings
 *
 * @package Soopno\Translations
 *
...
class BackendStrings
{
    ...
    public static function getCommonStrings()
    {
        return [
            ...
            'employee'                  => __('Model', 'wpamelia'),
            'employees'                 => __('Models', 'wpamelia'),
    ...
    public static function getSettingsStrings()
    {
        return [
            ...
            'minimum_time_before_canceling'          => __('Minimum time required before canceling/rescheduling', 'wpamelia'),
            'minimum_time_before_canceling_tooltip'  => __('Set the time before the appointment when customers<br/>will not be able to cancel/reschedule the appointment.', 'wpamelia'),
            ...
            'outlook_ssl_warning'                    => __('SSL (HTTPS) is not enabled. You will not be able to use Outlook Calendat integration until SSL is enabled.', 'wpamelia'),
     ...
     * @return array
     */
    public static function getLiveChatStrings()
    {
        return [
            'livechat'                     => __('Live Chat', 'wpamelia'),
        ];
    }
    ...
    public static function getCustomerStrings()
    {
        return [
            ...
            'customers'                    => __('Societés', 'wpamelia'),
